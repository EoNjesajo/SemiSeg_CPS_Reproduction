...
with Engine(custom_parser=parser) as engine:
    ...
    train_loader, train_sampler = get_train_loader(engine, Cloud, train_source=config.train_source, \
                                                   unsupervised=False)
    unsupervised_train_loader, unsupervised_train_sampler = get_train_loader(engine, Cloud, \
